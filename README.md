...
Once the `conda-forge` channel has been enabled, `sparkhpc` can be installed with:

```
conda install sparkhpc
```

It is possible to list all of the versions of `sparkhpc` available on your platform with:
